...
ORDER BY tv_shows.title, tv_show_genres.genre_id ASC;  -- Trie les résultats en fonction de tv_shows.title (en ordre croissant) et tv_show_genres.genre_id (en ordre croissant)
