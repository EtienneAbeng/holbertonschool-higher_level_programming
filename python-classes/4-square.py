...
La classe a une vérification pour s'assurer que la taille
est un entier positif lors de l'initialisation.
Si la taille n'est pas un entier ou si elle est négative,
